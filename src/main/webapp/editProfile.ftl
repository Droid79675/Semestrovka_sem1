...
<head>
    ...
    <script defer src="js/ajaxUpdate.js"></script>
</head>
<body>
        ...
        <div class="container py-5 h-100">
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col col-lg-9 col-xl-7">
                    <div class="card">
                        <form id="formEdit" method="post" action="/updateProfile" enctype="multipart/form-data">
                            <div class="rounded-top text-white d-flex flex-row" style="background-color: #000; height:200px;">
                                ...
                                <div class="row ms-2 justify-content-start" style="margin-top: 40px;">
                                    <div class="col-sm-10">
                                        <label>Login:</label>
                                        <input required type="text" class="form-control" name="profileLogin" id="profileLogin" />
                                    </div>
                                    <div class="col-sm-10">
                                        <label>Password:</label>
                                        <input required type="password" class="form-control" name="profilePassword" id="profilePassword" />
                                    </div>
                                </div>
                                <div class="row ms-2 justify-content-start" style="margin-top: 40px;">
                                    <div class="col-sm-10">
                                        ...
                                        <div class="form-check mb-3 mb-md-0" id="editSex">
                                            <input type="radio" name="sex" id="profileSexF" value="female" >
                                            <label class="form-check-label" for="profileSexF">Female</label>
                                            <input type="radio" name="sex" id="profileSexM" value="male" >
                                            <label class="form-check-label" for="profileSexM">Male</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body p-4 text-black">
                                <div class="mb-5">
                                    ...
                                    <div class="p-4" style="background-color: #f8f9fa;">
                                        <input type="text" class="form-control" name="profileAbout" id="profileAbout" style="width: 650px;height: 100px"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 d-flex justify-content-center">
                                ...
                                <p style="color:red" id="errorEdit" hidden></p>
                            </div>
                        </form>
                    </div>
                </div>
