...
public class Profile extends User{
    ...
    public Profile(String name, String oldEmail, String password, String birthday, String sex, String avatar, String about) {
        super(name, oldEmail, password, birthday, sex);
        this.about = about;
